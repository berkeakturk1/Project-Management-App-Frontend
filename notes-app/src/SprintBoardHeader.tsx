...
const SprintBoardHeader = () => {
  return (
    <Box sx={{ flexGrow: 1, marginTop: 10 }}>
      <Box sx={{ backgroundColor: '#fff', padding: '20px 28px', borderBottom: '1px solid #e1e4e8', borderRadius: '8px 8px 0 0' }}>
        <Toolbar sx={{ justifyContent: 'space-between', padding: '0 16px' }}> {/* Added padding to match screen edges */}
          ...
          <Box display="flex" alignItems="center">
            ...
            <Box sx={{ marginLeft: 1, backgroundColor: '#e1e4e8', color: '#000', padding: '3px 8px', borderRadius: 2, fontSize: 14 }}>
              Beta
            </Box>
          </Box>
        ...
        <Toolbar sx={{ justifyContent: 'space-between', paddingTop: 3, padding: '0 16px' }}> {/* Matching padding with the header */}
